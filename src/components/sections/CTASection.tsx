...
export const CTASection = () => {
  return <section className="py-20 bg-gradient-to-r from-primary via-primary-glow to-secondary relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center mx-[50px]">
